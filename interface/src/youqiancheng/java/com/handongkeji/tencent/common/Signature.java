...
import com.handongkeji.util.DecriptUtil;
...
//        Util.log("Sign Result:" + result);
    ...
    public static String getSign(Map<String,Object> map){
        ...
        String result = sb.toString();
        result += "key=" + Configure.getKey();
        Util.log("\n提示信息：Sign Before MD5:" + result);
        result = MD5.MD5Encode(result).toUpperCase();
         Util.log("\n提示信息：Sign Result:" + result);
        return result;
    }
...
//       	result=result.substring(0, result.lastIndexOf("&")<result.length()-1?result.length():result.lastIndexOf("&"));
//        	result=result.substring(0, result.length()-1);
//        }
//        result += "key=" + Configure.getKey(); //no key
        Util.log("\n提示信息：Sign Before SHA1:" + result);
//        result = MD5.MD5Encode(result).toUpperCase();
        result=DecriptUtil.SHA1(result);
         Util.log("\n提示信息：Sign Result:" + result);
        return result;
    }

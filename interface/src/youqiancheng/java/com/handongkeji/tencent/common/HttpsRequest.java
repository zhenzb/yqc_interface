...
import com.handongkeji.tencent.service.IServiceRequest;
...
public class HttpsRequest implements IServiceRequest {
    ...
    private void init() throws IOException, KeyStoreException, UnrecoverableKeyException, NoSuchAlgorithmException, KeyManagementException {
        ...
        InputStream instream = HttpsRequest.class.getClassLoader().getResourceAsStream("cert/apiclient_cert.p12");

       System.out.println("密码："+Configure.getCertPassword());
       System.out.println("回调函数url："+Configure.getNOTIFY_URL());
        try {

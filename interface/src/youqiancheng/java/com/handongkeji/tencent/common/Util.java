...
public class Util {
	...
	public static String formatData(Object postData){
    ...
    public static String getCertPath(HttpServletRequest request){
		...
		logger.i("服务器路径:" + basePath); 
		basePath +="WEB-INF"+File.separator+"classes"+File.separator+"cert"+File.separator+ "static/apiclient_cert.p12";

...
import com.youqiancheng.service.app.service.B07AuthenticationAppService;
...
@Service
@Transactional
public class B07AuthenticationAppServiceImpl implements B07AuthenticationAppService {
    @Autowired
    ...
    public int insert(B07AuthenticationDO b07Authentication) {
        ...
        if(StringUtils.isBlank(b07Authentication.getBankCardNum())){
            throw new JsonException(ResultEnum.PARAM_VERIFY_FAIL,"银行卡号不能为空");
        }
        try{
        ...
        b01UserDO.setIsAuthentication(StatusConstant.isAuthentication.authentication.getCode());
    ...
    public static void main(String[] args) {
        String str="131125199202220110";
        String substring = str.substring(6, 10);
        String substring1 = str.substring(10, 12);

...
public class D02OrderItemClientVO2 {
    ...
    private D02OrderItemClientVO orderItem;
    @ApiModelProperty(value = "退款明细",name ="orderItem")
    private List<D02OrderItemClientVO> list;

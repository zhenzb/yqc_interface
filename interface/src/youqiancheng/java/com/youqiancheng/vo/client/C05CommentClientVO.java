 ...
 */
@Data
@ApiModel(value = "评论实体以及回复评论的内容")
public class C05CommentClientVO implements Serializable {
    ...
    private Integer replyComentNumber;

    @ApiModelProperty(value = "回复评论的评论",name ="c14ReplyCommentDOS")
    private List<C14ReplyCommentDO> c14ReplyCommentDOS;

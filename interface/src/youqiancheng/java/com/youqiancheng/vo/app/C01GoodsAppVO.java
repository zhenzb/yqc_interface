 ...
 */
@Data
@ApiModel(value = "APP视图——商品表实体")
public class C01GoodsAppVO implements Serializable {
    ...
    private String area;
    @ApiModelProperty(value = "商家logo", name = "shopLogo")
    private String shopLogo;
    @ApiModelProperty(value = "评论数", name = "evaluateCount")
    private int evaluateCount;
    @ApiModelProperty(value = "商家类型", name = "goodsType")
    private String goodsType;
    @ApiModelProperty(value = "商家所有人Id", name = "userId")
    private long userId;

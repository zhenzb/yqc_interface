...
public class RefundReqData
{
     ...
     */
    public RefundReqData(String appid, String transactionID, String outTradeNo, String deviceInfo, String outRefundNo, int totalFee, int refundFee, String opUserID, String refundFeeType)
    {
        ...
        //随机字符串，不长于32 位
        setNonce_str(randomStringByLength(32));

        //根据API给的签名规则进行签名
        String sign = sign(toMap());

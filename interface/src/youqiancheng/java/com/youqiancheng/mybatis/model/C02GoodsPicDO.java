 ...
 */
@Data
@ApiModel(value = "商品图实体")
@TableName("c02_goods_pic")
public class C02GoodsPicDO implements Serializable {
    private static final long serialVersionUID = 1L;
    @ApiModelProperty(value = "id(数据库自增)",name ="id",example = "1",notes = "自增主键在新增时无需传入")
    private Long id;
    @ApiModelProperty(value = "轮播图URL",name ="picUrl")
    ...
    @ApiModelProperty(value = "对应商品:房间，商品，宣传",name ="type")
    private int type;

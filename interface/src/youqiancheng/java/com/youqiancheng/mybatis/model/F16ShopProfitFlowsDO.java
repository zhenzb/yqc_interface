...
@TableName("f16_shop_profit_flows")
public class F16ShopProfitFlowsDO implements Serializable {
    ...
    @ApiModelProperty(value = "收益日期",name ="incomeDay")
    private LocalDateTime incomeDay;
